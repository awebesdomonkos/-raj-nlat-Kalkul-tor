...
import { HistoryIcon, XIcon, SearchIcon, TrashIcon, DuplicateIcon, PdfIcon, SitemapIcon } from './icons';
                        ...
                        <ul className="space-y-3">
                            {filteredHistory.map(item => {
                                ...
                                const total = item.state.selectedPackageId === PackageId.CONTINUOUS_MAINTENANCE
                                    ...
                                    ? pkg?.price ?? null
                                    : (() => {
                                        // Quick total calc from saved state
                                        let t = pkg?.price ?? 0;
                                    ...
                                    >
                                        ...
                                        <div className="flex items-start justify-between gap-4 flex-wrap">
                                            ...
                                            <div className="flex items-center gap-2 flex-wrap flex-shrink-0">
                                                ...
                                                {/* Site Map PDF (only for website packages) */}
                                                {hasSitemap && (
                                                    <button
